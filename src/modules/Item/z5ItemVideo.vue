<template>
    <div class ="container-video" ref="container_video" :style="container_options">   
...
const container_options = ref(null)
...
function calcularWidth() {
  ...
  //let cwidth = container_video.value.getBoundingClientRect().width;
  let cwidth = 0
  let wwidth = window.innerWidth
  if (wwidth<=783) { 
    cwidth = Math.floor(0.89*(wwidth-500)+405)
  } else if (wwidth<=1067) {
    cwidth = Math.floor(0.42*(wwidth-783)+658)
  }
  else {
